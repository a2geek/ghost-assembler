 ...
 * @author Rob
 */
public class Test6502Definition {
	@Test
	public void test_ADC_to_BRK() throws IOException, AssemblerException {
		...
		AsmAssert.assemble("Test-6502-adc-to-brk.asm", expected);
	}
	@Test
	public void test_BVC_to_EOR() throws IOException, AssemblerException {
		...
		AsmAssert.assemble("Test-6502-bvc-to-eor.asm", expected);
	}
	@Test
	public void test_INC_to_LDY() throws IOException, AssemblerException {
		...
		AsmAssert.assemble("Test-6502-inc-to-ldy.asm", expected);
	}
	@Test
	public void test_LSR_to_SBC() throws IOException, AssemblerException {
		...
		AsmAssert.assemble("Test-6502-lsr-to-sbc.asm", expected);
	}
	@Test
	public void test_SEC_to_TXS() throws IOException, AssemblerException {
		...
		AsmAssert.assemble("Test-6502-sec-to-tya.asm", expected);
	}
	@Test
	public void testFastMultiplyBy10() throws IOException, AssemblerException {
		byte[] expected = {
				0x0a,					// MULT10  ASL         ;multiply by 2
			    (byte)0x8d, 0x0b, 0x03,	//         STA TEMP    ;temp store in TEMP
			    0x0a,					//         ASL         ;again multiply by 2 (*4)
			    0x0a,					//         ASL         ;again multiply by 2 (*8)
			    0x18,					//         CLC
			    0x6d, 0x0b, 0x03,		//         ADC TEMP    ;as result, A = x*8 + x*2
			    0x60,					//         RTS
			    0x00,					// TEMP    .byte 0
			};
